...
{
    public class MenuController : BaseGameBehaviour
    {
        ...
        public void SetDifficultyByIndex(int index)
        {
            ...
            switch (index)
            {
                ...
                case 2: // Hard
                    if (!playerData.completedMediumMode) return;
            ...
            {
                SceneLoader.instance.LoadSinglePlayerDuel(); // Changed from LoadDuel()
            }
        }
        ...
        public void MultiplayerPlayButton()
        {
            ...
            {
                playersReady = true;
                SceneLoader.instance.LoadMultiplayerDuel(); // Changed from LoadMultiplayer()
            }
        }
        ...
        private void UpdateDifficultyButtons()
        {
            ...
            difficultyText[0].color = activeTextColor;
